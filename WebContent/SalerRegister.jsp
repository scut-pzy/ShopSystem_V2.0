            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <span class="glyphicon glyphicon-user"></span>销售人员注册
                    </div>
                    <div class="panel-body">
                    
                        <form method="post" action="${pageContext.request.contextPath }/RegisterServlet?cancer=sale" name="RegisterForm" onSubmit="return login(this);">
